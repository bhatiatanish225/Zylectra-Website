      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-8 lg:gap-12 mb-12 sm:mb-16">
          ...
          <div className="relative">
                ...
                <div className="bg-white w-full h-full rounded-[1.25rem] sm:rounded-[2.25rem] relative overflow-hidden">
                  ...
                  <div className="p-3 sm:p-4 bg-white">
                    <div className="flex justify-between items-center mb-2">
                      <span className="pre-heading text-gray-600">ETA: 12 min</span>
                      <span className="pre-heading text-emerald-600 font-semibold">85% Battery</span>
                    </div>
                    <div className="bg-emerald-100 rounded-lg p-2 sm:p-3">
                      <div className="pre-heading text-emerald-800">Optimal Route Found</div>
                      <div className="text-xs sm:text-sm font-semibold text-emerald-900">
                        Save 8 min • 2 chargers available
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="absolute -bottom-3 sm:-bottom-4 left-1/2 transform -translate-x-1/2 bg-white px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg shadow-lg border border-gray-200">
              <div className="flex items-center gap-1.5 sm:gap-2 pre-heading text-gray-600">
          ...
          <div className="relative">
            <div
              className="bg-gray-800 rounded-[1.5rem] sm:rounded-[2rem] p-2 shadow-2xl hover:scale-105 transition-transform duration-300 animate-fade-in-up"
              ...
              <div className="bg-black rounded-[1rem] sm:rounded-[1.5rem] w-56 h-[460px] sm:w-64 sm:h-[520px] relative overflow-hidden">
                <div className="bg-white w-full h-full rounded-[0.75rem] sm:rounded-[1.25rem] relative overflow-hidden">
                  ...
                  <div className="bg-emerald-700 px-3 sm:px-4 py-2 sm:py-3 text-white">
                    ...
                    <div className="pre-heading opacity-90">Fleet Dashboard</div>
                  </div>
                  ...
                  <div className="p-3 sm:p-4 bg-gray-50 h-full">
                    ...
                    <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-3 sm:mb-4">
                      <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                        <div className="pre-heading text-gray-500">Active Vehicles</div>
                        <div className="text-base sm:text-lg font-bold text-emerald-600">24</div>
                      </div>
                      <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                        <div className="pre-heading text-gray-500">Charging</div>
                      ...
                      <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="pre-heading font-medium">Vehicle #001</span>
                          </div>
                          <span className="pre-heading bg-green-100 text-green-800 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                            En Route
                          </span>
                        </div>
                        <div className="pre-heading text-gray-500 mt-0.5 sm:mt-1">Battery: 78% • ETA: 15 min</div>
                      </div>
                      ...
                      <div className="bg-white rounded-lg p-2 sm:p-3 shadow-sm">
                        <div className="flex justify-between items-center">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="pre-heading font-medium">Vehicle #002</span>
                          </div>
                          <span className="pre-heading bg-blue-100 text-blue-800 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded">
                            Charging
                          </span>
                        </div>
                        <div className="pre-heading text-gray-500 mt-0.5 sm:mt-1">Battery: 45% • Time left: 22 min</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 sm:gap-4 bg-emerald-100 px-6 sm:px-8 py-3 sm:py-4 rounded-full">
            ...
            <span className="sub-heading text-emerald-800 font-semibold">
